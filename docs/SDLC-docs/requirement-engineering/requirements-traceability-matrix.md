...
| **Related SDD** | SDD-BUILDNEST-001 v4.9 — `docs/SDLC-docs/design/software-design-description.md` |
...
| Location-Based Matching (FR-LOC) *(Ph-3, Planned — excluded from Totals above)* | 4 | 2 | 0 | 0 | 0 | 2 |
...
> FR-LOC-01/02 (district reference-data model) are implemented (#562). FR-LOC-03/04 remain not started. OQ-01/OQ-02 are resolved via [ADR 0001](../design/adr/0001-district-matching-strategy-for-location-based-seller-buyer-matching.md) (#561) — radius/seller-declared matching, fixed admin-maintained reference table — see SDD §4.5.6 for the finalized design; #563/#564 remain the outstanding implementation issues.
