...
| **Related SDD** | SDD-BUILDNEST-001 v4.10 — `docs/SDLC-docs/design/software-design-description.md` |
...
| Location-Based Matching (FR-LOC) *(Ph-3, Planned — excluded from Totals above)* | 4 | 3 | 0 | 0 | 0 | 1 |
