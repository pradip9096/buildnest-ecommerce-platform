...
| :--- | :--- | :--- | :--- |
| Counter | LINE | LINE | LINE |
| Minimum | 0.40 (40%) | 0.40 (gate maintained) | **0.70 (70%)** |
| Report location | `target/site/jacoco/index.html` | — | — |
| Excluded packages | `model.entity.*` (Lombok-generated) | Unchanged | Unchanged |

> **Note**: The current JaCoCo gate (`pom.xml`) is set to `0.40`. This gate must be raised to `0.70` as part of Phase 2 work (SRS MNT-02). The gate must not be lowered below `0.40` at any time during Phase 1. JaCoCo report is generated by `./mvnw verify`.
...
| JaCoCo gate passes at 0.40 | Pass | `./mvnw verify` |
...
| Criterion | Target | Measurement |
| :--- | :--- | :--- |
| JaCoCo LINE coverage | **≥ 70%** | `./mvnw verify -P coverage` |
| PIT mutation score | **≥ 75%** | `./mvnw pitest:mutationCoverage -P coverage` |
