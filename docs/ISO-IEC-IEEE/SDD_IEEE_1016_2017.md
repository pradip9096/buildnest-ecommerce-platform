...
> This document conforms to **ISO/IEC/IEEE 1016:2017**, _Systems and software engineering — Software design descriptions_. It provides design viewpoints (Context, Composition, Logical, Dependency, Information, Patterns, Interface, Interaction, State Dynamics, Resource) to address stakeholder concerns.
