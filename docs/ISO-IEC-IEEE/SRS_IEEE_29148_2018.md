...
| FR-FE-03 | The frontend shall implement client-side routing using **React Router**                                             | High     | Test          |
| FR-FE-04 | The frontend shall provide a responsive design supporting Desktop, Tablet, and Mobile viewports                     | High     | Demonstration |
| FR-FE-05 | The frontend shall manage global state (User Session, Cart) using **Context API** or **Redux**                      | High     | Inspection    |
...
| FR-FE-09 | The frontend shall validate forms client-side (e.g., using **Formik** or **React Hook Form**) before submission     | Medium   | Test          |
