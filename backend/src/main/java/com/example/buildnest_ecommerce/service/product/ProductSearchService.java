 ...
 *
 * Beans of this type are only registered when
 * {@code elasticsearch.enabled=true}; callers must inject
 * {@code Optional<ProductSearchService>} and fall back to the
 * JPA-backed search when the bean is absent.
 */
public interface ProductSearchService {

    /**
     * Full-text search with optional category / price / stock / district
     * filters (districtId added FR-LOC-03, #563). Returns a
     * relevance-ordered page of ProductDocuments.
     */
