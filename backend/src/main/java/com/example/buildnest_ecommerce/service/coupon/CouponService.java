...
public interface CouponService {
     ...
     * @throws com.example.buildnest_ecommerce.exception.ResourceNotFoundException
     *                                                                       if no coupon with this code exists
     * @throws com.example.buildnest_ecommerce.exception.ValidationException if
     *                                                                       the coupon is inactive, expired, usage-limit
     *                                                                       exceeded, or the subtotal is below the
     *                                                                       coupon's minimum order value
     */
     ...
     */
    Coupon createCoupon(String code, Coupon.DiscountType discountType, BigDecimal discountValue,
