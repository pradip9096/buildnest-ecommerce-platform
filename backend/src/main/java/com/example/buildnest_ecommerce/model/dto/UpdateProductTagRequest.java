...
/**
 * Request body for updating a {@code ProductTag} (PROD-03).
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
public final class UpdateProductTagRequest {
    /** Maximum allowed length of {@link #name}. */
    private static final int MAX_NAME_LENGTH = 100;

    /** New tag name; the slug is re-derived from this server-side. */
